<template>
  <div class="dark:bg-gray-900 dark:text-white w-screen md:px-20 mx-auto">
    <div
      class="flex flex-col md:grid md:grid-cols-3 gap-4 container mx-auto dark:bg-gray-900 dark:text-white"
    >
      <RouterLink to="#">
        <div
          class="flex flex-col max-h-72 text-center items-center mx-auto gap-4 border-2 border-teal-500 p-14 md:p-20 mb-10 w-2/3 md:min-w-full hover:bg-teal-500 hover:text-white hover:shadow-lg hover:shadow-teal-500/50 hover:border-teal-500 hover:dark:bg-teal-500 hover:dark:text-white hover:dark:shadow-teal-500/50 hover:dark:border-teal-500"
        >
          <div>
            <svg
              class="w-24"
          ...
          <div class="uppercase">our pricing</div>
        </div>
      </RouterLink>
        ...
        >
          <div>
            ...
            >
              <g>
                <path
                  d="M7,25c-1.7,0-3-1.3-3-3V10c0-1.7,1.3-3,3-3s3,1.3,3,3v12C10,23.7,8.7,25,7,25z"
                />
              </g>
              <g>
                <path
                  d="M25,25c-1.7,0-3-1.3-3-3V10c0-1.7,1.3-3,3-3s3,1.3,3,3v12C28,23.7,26.7,25,25,25z"
                />
              </g>
              <g>
                <path
                  d="M23,17H9c-0.6,0-1-0.4-1-1s0.4-1,1-1h14c0.6,0,1,0.4,1,1S23.6,17,23,17z"
                />
              </g>
              <g>
                <path
                  d="M2,10.2c-1.2,0.4-2,1.5-2,2.8v6c0,1.3,0.8,2.4,2,2.8V10.2z"
                />
                <path
                  d="M30,10.2v11.6c1.2-0.4,2-1.5,2-2.8v-6C32,11.7,31.2,10.6,30,10.2z"
                />
              </g>
            </svg>
          </div>
          <div class="uppercase">fitness program</div>
        </div>
      </RouterLink>
